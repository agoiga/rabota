...
\begin{figure}
\center{\includegraphics[width=5cm]{G:/Diplom/om.png}}\caption{Схема свёрточной сети, использованной в обучении.}
\end{figure}
...
\includegraphics[width=13cm]{G:/Diplom/it1.jpg}

\includegraphics[width=13cm]{G:/Diplom/it2.jpg}
...
\begin{figure}
\center{\includegraphics[width=12cm]{G:/Diplom/st.jpg}}\caption{Схема одного из первых примеров применения механизмов внимания в глубоких нейронных сетях при помощи машин больцмана терьего порядка, созданая Юго Ларошелем и Хинтоном[6].}
\end{figure}
