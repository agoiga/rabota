...
% Тема
\topic{Глубокие нейронные сети для распознавания формул на изображениях}
...
\begin{figure}
\center{\includegraphics[width=5cm]{om.png}}\caption{Схема свёрточной сети, использованной в обучении.}
\end{figure}
...
\includegraphics[width=14cm]{it1.jpg}

\includegraphics[width=14cm]{it2.jpg}
