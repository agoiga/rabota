...
% Тема
\begin{center}
\normalsize{\textbf{Глубокие нейронные сети для распознования формул на изображениях}}
\end{center}
...
\begin{flushleft}
\small{Научный руководитель,\\ ведущий инжинер-исследователь,\\ к.ф.-м.н.\hspace{12,2cm} Еськин В.А.}
\end{flushleft}
...
\begin{figure}[H]
\center{\includegraphics[width=7.97cm]{G:/Diplom/h1.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=7.97cm]{G:/Diplom/h2.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=17cm]{G:/Diplom/gru.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=13cm]{G:/Diplom/it1.jpg}}
\center{\includegraphics[width=13cm]{G:/Diplom/it2.jpg}}
...
\begin{figure}[H]
\center{\includegraphics[width=8cm]{G:/Diplom/bleugru.jpg}}
\caption{Пример графика значений BLEU score.}
\label{fig:image1.5}
\includegraphics[width=8cm]{G:/Diplom/lbgru.jpg}
\caption{Пример графика значений ошибки по батчам.}
\label{fig:image1.6}
\includegraphics[width=8cm]{G:/Diplom/valgru.jpg}
...
\begin{figure}[H]
\center{\includegraphics[width=15cm]{G:/Diplom/tran.jpg}}\caption{Схема сети основанной на ''Трансформере'' , которая использовалась в обучении.}
\label{fig:image2.2}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[width=8cm]{G:/Diplom/bleutr.jpg}}
\caption{Пример графика значений BLEU score.}
\label{fig:image2.3}
\end{figure}
\begin{figure}[H]
\center{\includegraphics[width=8cm]{G:/Diplom/lbtr.jpg}}
\caption{Пример графика значений ошибки по батчам.}
\label{fig:image2.4}
\end{figure}
\begin{figure}[H]
\center{\includegraphics[width=8cm]{G:/Diplom/valtr.jpg}}
\caption{Пример графика значений ошибок при работе с проверочной частью.}
\label{fig:image2.5}
\end{figure}
