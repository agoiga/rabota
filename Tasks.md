...
### Задания на период 21.11.2020 - 27.11.2020

1. Освоение Python. Книга Наоми Седер "Python. Экспресс-курс": главы 9-11.
2. Сделать задания для самопроверки из глав 9-11.
3. Реферат по современным нейронным сетям:
	* добавить иллюстрации к методу обратного распространения ошибки
	* Типы нейронных сетей (полносвязная, свёрточная, рекуррентная) - определение, особенности работы, иллюстрация нейронной сети и метода работы, математическое описание (формульное), которое описывает метод работы нс

### Задания на период 27.11.2020 - 04.12.2020

1. Освоение Python. Книга Наоми Седер "Python. Экспресс-курс": главы 9-11.
2. Сделать задания для самопроверки из глав 9-11.
3. Реферат по современным нейронным сетям:
	* поправить и дополнить иллюстрации к методу обратного распространения ошибки
	* выписать поясняющие формулы к методу обратного распространения ошибки
	* наиболее актуальные и востребованные методы оптимизации нейронных сетей
